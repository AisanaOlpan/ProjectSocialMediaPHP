...
then click on "go" 
 ...
 4)click on "Databases" ( Bases de données )  then write inside the Database Name : "pictogram" then click on "create"
...
7) Now we need to create the second table :
	a)click on "pictogram" (which is the name of our database )
