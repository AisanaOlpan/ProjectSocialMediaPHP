    ...
    <div class="login">
        <div class="col-lg-4 col-md-8 col-sm-12 bg-white border shadow-sm cardmodule">
            <?php
...
<br>
                <button class="btn btn-primary btn_custom" type="submit">Send Verification Code</button>
...
?>
                ...
                <h6> <a href="?login" class="text-decoration-none text_custom mt-5"><i class="bi bi-arrow-left-circle-fill"></i> Go Back
                    To
                    Login</a></h6>
            </form>
        </div>
