<?php global $user;?>
    <nav class=" navbar navbar-expand navbar-light bg-white border ">
        <div class="col-sm-12  d-flex flex-lg-row flex-md-row flex-sm-column justify-content-between">
            <div class="d-flex justify-content-between col-lg-8 col-sm-12" style="width:40%"> 
        ...
        <!-- <a class="nav-link" data-widget="pushmenu" href="#" role="button"><i class="fas fa-bars"></i></a> -->
            ...
            <form class="d-flex" id="searchform">
                    <input class="form-control me-2" type="search" id="search" placeholder="search..."
                        aria-label="Search" autocomplete="off" style = "border-radius: 4.25rem; text-align: center;">
