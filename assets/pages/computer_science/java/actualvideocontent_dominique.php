                  ...
                  echo '<div class="card_item">
                    <div class="card-header" id="headingOne">
                      <h2 class="mb-0">
                        ...
                        <a href="?computer_science_java_dominique">  Chapitre 0 : Introduction</a>
                        </button>
                      </h2>
                    </div>
                    ...
                    <div id="collapseOne" class="collapse show" aria-labelledby="headingOne" data-parent="#accordionExample">
                      <div class="card-body">
                        <a href="?videoD=1">&#10170  Préparation de l\'environnement de développement JAVA</a><br>
                        <a href="?videoD=2">&#10170  Premiére application JAVA</a><br>
                        <a href="?videoD=3">&#10170  Compilation et portabilité des codes JAVA</a><br>
                      </div>
                    </div>
                  </div>';
                  break;
                  ...
                  <div class="card_item">
                    <div class="card-header" id="headingTwo">
                      <h2 class="mb-0">
                        ...
                        <a href="?computer_science_java_dominique">  Chapitre 1 : Manipulation des types de données</a>
                        </button>
                      </h2>
                    </div>
                    <div id="collapseTwo" class="collapse show" aria-labelledby="headingTwo" data-parent="#accordionExample">
                      <div class="card-body">
                        <a href="?videoD=4">&#10170  Manipulation des types entiers en Java</a><br>
                        <a href="?videoD=8">&#10170  Le type boolean (booléen)</a><br>
                        <a href="?videoD=9">&#10170  Manipulation de caractères en Java.</a><br>
                        <a href="?videoD=10">&#10170  Utilisation de chaînes de caractères en Java</a><br>
                        <a href="?videoD=13">&#10170  Les tableaux Java</a><br>
                        <a href="?videoD=14">&#10170  Définition d\'un type énuméré.</a><br>
                      </div>
                    </div>
                  </div>';
                  break;
                  ...
                  <div class="card_item">
                    <div class="card-header" id="headingThree">
                      <h2 class="mb-0">
                        ...
                        <a href="?computer_science_java_dominique">  Chapitre 2 : Operateur</a>
                        </button>
                      </h2>
                    </div>
                    <div id="collapseThree" class="collapse show" aria-labelledby="headingThree" data-parent="#accordionExample">
                      <div class="card-body">
                        <a href="?videoD=5">&#10170  Opérateurs ++ (incrément) et -- (décrément)</a><br>
                        <a href="?videoD=6">&#10170  Utilisation des opérateurs binaires</a><br>
                        <a href="?videoD=16">&#10170  La table de précédence des opérateurs Java</a><br>
                  ...
                  <div class="card_item">
                    <div class="card-header" id="headingFour">
                      <h2 class="mb-0">
                        ...
                        <a href="?computer_science_java_dominique">     Chapitre 3 : Les instructions conditionnelles</a>
                        </button>
                      </h2>
                    </div>
                    <div id="collapseFour" class="collapse show" aria-labelledby="headingFour" data-parent="#accordionExample">
                      <div class="card-body">
                        <a href="?videoD=18">&#10170  Les instructions conditionnelles</a><br>
                        <a href="?videoD=19">&#10170  Le nouveau switch de Java SE 14</a><br>
                      </div>
                    </div>
                  </div>';
                  break ;
                  ...
                  <div class="card_item">
                    <div class="card-header" id="headingFive">
                      <h2 class="mb-0">
                        ...
                        <a href="?computer_science_java_dominique">   Chapitre 4 : Les boucles</a>
                        </button>
                      </h2>
                    </div>
                    <div id="collapseFive" class="collapse show" aria-labelledby="headingFive" data-parent="#accordionExample">
                      <div class="card-body">
                        <a href="?videoD=20">&#10170  Les instructions de boucles</a><br>
                        <a href="?videoD=21">&#10170  L\'instruction foreach en Java</a><br>
                        <a href="?videoD=22">&#10170  Les instructions de débranchement (break et continue)</a><br>
                      </div>
                    </div>
                  </div>';
                  break ;
                  ...
                  <div class="card_item">
                    <div class="card-header" id="headingSix">
                      <h2 class="mb-0">
                        ...
                        <a href="?computer_science_java_dominique">    Chapitre 5 : Programmation orienté objet</a>
                        </button>
                      </h2>
                    </div>
                    <div id="collapseSix" class="collapse show" aria-labelledby="headingSix" data-parent="#accordionExample">
                      <div class="card-body">
                        <a href="?videoD=32">&#10170  Introduction à la Programmation Orientée Objet et principe d\'encapsulation</a><br>
                        <a href="?videoD=33">&#10170  Mise en oeuvre du concept d\'héritage.</a><br>
                        <a href="?videoD=34">&#10170  Méthodes abstraites, classes abstraites et interfaces</a><br>
                        <a href="?videoD=35">&#10170  Implémentations d\'interfaces</a><br>
                      </div>
                    </div>
                  </div>';
                  break ;
                  ...
                  <div class="card_item">
                    <div class="card-header" id="headingSeven">
                      <h2 class="mb-0">
                        ...
                        <a href="?computer_science_java_dominique">    Chapitre 6 : Les exceptions</a>
                        </button>
                      </h2>
                    </div>
                    <div id="collapseSeven" class="collapse show"  aria-labelledby="headingSeven" data-parent="#accordionExample">
                      <div class="card-body">
                        <a href="?videoD=38">&#10170  Introduction au mécanisme d\'exceptions en Java</a><br>
                        <a href="?videoD=39">&#10170  Mise en oeuvre d\'une classe d\'exception</a><br>
                      </div>
                    </div>
                  </div>';
                  break ;
