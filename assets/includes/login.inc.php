     ...
     if($enreg=$req->fetch()){/*we found the info about the given uid or email*/
       ...
       if ($pwdCheck== false ){/*Wrong password*/
         ...
         exit();
          ...
          session_start();
          $_SESSION['userId']=$enreg['id'];
          $_SESSION['userUid']=$enreg['uidUsers'];
					$_SESSION['userEmail']=$enreg['email'];
